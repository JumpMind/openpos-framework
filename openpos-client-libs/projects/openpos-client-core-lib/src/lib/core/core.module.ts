...
import { BarcodeScanner } from './platform-plugins/image-scanners/barcode-scanner.service';
...
import { AilaScannerCordovaPlugin } from './platform-plugins/image-scanners/aila-scanner-cordova/aila-scanner-cordova.plugin';
